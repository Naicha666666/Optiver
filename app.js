...
$('#start').onclick=begin;$('#again').onclick=begin;$('#submit').onclick=submit;$('#reset').onclick=()=>{sel.fill(0);$('#feedback').className='feedback hidden';update()};$('#skip').onclick=()=>{round++;load()};$('#how').onclick=()=>{resetDemo();$('#modal').showModal()};$('#close').onclick=()=>$('#modal').close();$('#gotit').onclick=()=>{if(!$('#gotit').disabled){$('#modal').close();if(!$('#intro').classList.contains('hidden'))begin()}};
